                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
						<?php
							...
							$count = 1; 
							foreach($subjects->result_array() as $row):
						?>
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/subject/delete/<?php echo $row['subject_id']."/".$row['class_id'];?>');">
